$(document).ready(function () {    
    ...
    $('.add_shem').click(function () {
        $('.block_popup').fadeIn(300);
    });

    $('.close').click(function () {
        $('.block_popup, .block_popup_2, .block_popup_3, .block_popup_4').fadeOut(300);
    });

    $('.add_sh_info').click(function () {
        $('.block_popup_2').fadeIn(300);
    });
    $('.login_check').click(function (e) {
        e.preventDefault();
        $('.block_popup_3').fadeIn(300);
    });
    $('.registr_check').click(function (e) {
        e.preventDefault();
        $('.block_popup_4').fadeIn(300);
    });
